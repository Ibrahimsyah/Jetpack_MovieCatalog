...
class LocalDataSource private constructor(private val movieDao: MovieDao) {
    ...
    fun getFavouriteMovies(): DataSource.Factory<Int, MovieEntity> = movieDao.getAllFavoriteMovies()

    fun getFavoriteTvShows(): DataSource.Factory<Int, MovieEntity> = movieDao.getAllFavoriteTvShows()

    fun insertFavoriteMovie(movie : MovieEntity) = movieDao.insert(movie)

    fun deleteFavoriteMovie(movie: MovieEntity) = movieDao.delete(movie)
